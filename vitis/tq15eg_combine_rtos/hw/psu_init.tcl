...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01010400
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010400
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
    ...
    mask_write 0XFD1A00A0 0x01003F07 0x01000500
    ...
    mask_write 0XFD1A0070 0x013F3F07 0x01010502
    ...
    mask_write 0XFD1A0074 0x013F3F07 0x01013F00
    ...
    mask_write 0XFD1A007C 0x013F3F07 0x010A0600
    ...
    mask_write 0XFD1A00C0 0x01003F07 0x01000300
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x783C1FFF 0x50240000
    ...
    mask_write 0XFF180208 0xFFFFC000 0x00B00000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x0001007E 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>

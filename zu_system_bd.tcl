...
set_property CONFIG.PSU__TTC0__PERIPHERAL__ENABLE {1} [get_bd_cells sys_ps8]
...
ad_connect spi0_csn_2_o sys_ps8/emio_spi0_ss2_o_n
ad_connect spi0_csn_1_o sys_ps8/emio_spi0_ss1_o_n
ad_connect spi0_csn_0_o sys_ps8/emio_spi0_ss_o_n
ad_connect spi0_csn_i   sys_ps8/emio_spi0_ss_i_n
ad_connect spi0_clk_i   sys_ps8/emio_spi0_sclk_i
ad_connect spi0_clk_o   sys_ps8/emio_spi0_sclk_o
...
# ------------------------------------------------------------------------------
# Interrupts - not used (software polls DMAC registers instead)
# Tie pl_ps_irq to constant 0
# ------------------------------------------------------------------------------
ad_ip_instance xlconstant const_irq_0
ad_ip_parameter const_irq_0 CONFIG.CONST_WIDTH 1
ad_ip_parameter const_irq_0 CONFIG.CONST_VAL 0

ad_connect const_irq_0/dout sys_ps8/pl_ps_irq0
ad_connect const_irq_0/dout sys_ps8/pl_ps_irq1
